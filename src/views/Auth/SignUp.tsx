...
const SignUp: React.FC = () => {
  ...
  const handleGoogleSignUp = async () => {
    ...
    if (ok) navigate(-1);
    else setError(t("auth.googleSignUpFailed"));
  };
          ...
          <form onSubmit={submit} className="p-8">
            <div className="space-y-5">
              ...
              <button
                ...
                className="dark:hover:bg-gray-750 flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white py-3 font-medium text-gray-700 shadow-sm transition-all hover:bg-gray-50 focus:ring-4 focus:ring-gray-200/50 disabled:opacity-70 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
              >
                {isGoogleLoading ? (
                  <svg
                    className="h-5 w-5 animate-spin"
