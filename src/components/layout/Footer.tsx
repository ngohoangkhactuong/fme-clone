...
export const Footer = () => (
  <footer className="relative overflow-hidden border-t border-blue-100 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900">
    <div className="absolute top-0 right-0 h-96 w-96 rounded-full bg-blue-600/10 blur-3xl"></div>
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div className="lg:col-span-2">
            ...
            <p className="mb-6 text-sm leading-relaxed text-blue-100">
              Đơn vị đào tạo kỹ sư cơ khí chất lượng cao, đáp ứng nhu cầu phát
              triển của ngành công nghiệp 4.0 và xã hội hiện đại.
            </p>
            <div className="flex gap-3">
              {[Facebook, Youtube, Linkedin, Instagram].map((Icon, idx) => (
                <a
                  key={idx}
                  href="#"
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link}>
                  ...
                  >
                    <span className="h-1.5 w-1.5 rounded-full bg-blue-400 transition-all group-hover:w-3"></span>
                    {link}
                  </a>
                </li>
              ))}
